...
# => 완벽하게 복사됨
copy['age'] = 25
print('원본:',dic)    #원본: {'name': '둘리', 'age': 20}
print('복사본:',copy) #복사본: {'name': '둘리', 'age': 25}
...
# 축구->테니스
# 복사본을 수정했는데 원본도 함께 수정 됨 =>얇은 복사
#  hobby는 리스트이고, 리스트의 값이 아닌 주소가 복사됨
# 따라서 원본과 복사본은 같은 리스트를 바라봄
copy['hobby'][0] ='테니스'
print(dic)  #{'name': '둘리', 'age': 20, 'hobby': ['축구', '야구']}
print(copy) #{'name': '둘리', 'age': 20, 'hobby': ['테니스', '야구']}
